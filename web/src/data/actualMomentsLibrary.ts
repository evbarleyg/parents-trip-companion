  ...
  '2026-03-07': [
    {
      ...
      label: 'Istanbul photo from March 7, 2026',
    ...
    },
    {
      ...
      label: 'Istanbul photo from March 7, 2026',
      alt: 'Calm waterfront view from the last Istanbul day.',
      caption: 'Calm waterfront view from the last Istanbul day.',
    },
  ],
};
...
export const PHOTO_LIBRARY_ACTUAL_MOMENTS_BY_DATE: Record<string, TripActualMoment[]> = {
  ...
  '2026-03-07': [
    buildPhotoMoment(
      '2026-03-07',
      'Sat, Mar 7 - Istanbul photo library',
      'Imported from the local photo library by EXIF capture date. Two photos still show Istanbul on March 7, which extends past the current seeded Istanbul itinerary window; the GPS point is preserved, but day-level map zoom stays anchored to the seeded itinerary.',
